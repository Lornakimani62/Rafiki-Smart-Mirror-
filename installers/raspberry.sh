...
if command_exists plymouth; then
	...
	if [ -d $THEME_DIR ]; then
		...
		if sudo cp ~/MagicMirror/splashscreen/maxresdefault.jpg $THEME_DIR/MagicMirror/maxresdefault.jpg && sudo cp ~/MagicMirror/splashscreen/MagicMirror.plymouth $THEME_DIR/MagicMirror/MagicMirror.plymouth && sudo cp ~/MagicMirror/splashscreen/MagicMirror.script $THEME_DIR/MagicMirror/MagicMirror.script; then
